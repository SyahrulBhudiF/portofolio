...
const SplashScreen = () => {
    ...
    }, [typedText.length, config.fullText, config.timings.typing, config.timings.variance, config.timings.delay, showSecondText, getRandomDelay]);
    ...
    }, [showSecondText, typedResponse.length, config.responseText, config.timings.responseTyping, config.timings.responseVariance, config.timings.close, getRandomDelay]);
    ...
    const Cursor: React.FC<CursorProps> = React.memo(({show}) => (
        <motion.span
