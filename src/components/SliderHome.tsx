...
const SliderHome = () => {
  ...
  return (
    <span className="text-white font-bold text-[inherit] text-carousel inline-flex items-center w-[14em] max-sm:w-auto whitespace-nowrap overflow-hidden font-mono tracking-tight">
      {display}
    </span>
  );
};
