  ...
  return (
    <div className="absolute bottom-0 w-full h-full max-md:bottom-5 max-sm:bottom-8 overflow-hidden z-0">
      ...
      >
        ...
        <path d="M0,64 L360,128 L720,64 L1080,160 L1440,64 V320 H0 Z" fill="url(#gradient1)" />
        <defs>
      ...
      >
        ...
        <path d="M0,128 L360,96 L720,192 L1080,128 L1440,128 V320 H0 Z" fill="url(#gradient2)" />
        <defs>
      ...
      >
        ...
        <path d="M0,192 L360,160 L720,224 L1080,192 L1440,192 V320 H0 Z" fill="url(#gradient3)" />
        <defs>
