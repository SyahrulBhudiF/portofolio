...
const TechStack: React.FC<{ stack: string }> = ({ stack }) => (
  <div className="retro-tech-block relative m-2 flex justify-center items-center gap-2 text-white border-2 border-purple-700/30 rounded-lg cursor-pointer overflow-hidden p-2 bg-purple-900/20 group">
                    ...
                    >
                      <div className="flex items-center justify-center w-8 h-8 bg-purple-700 rounded-full">
                        <svg
                          ...
                          aria-labelledby={`linkedin-icon-${contributor.name}`}
                          role="img"
                        >
                          <title id={`linkedin-icon-${contributor.name}`}>LinkedIn Profile</title>
